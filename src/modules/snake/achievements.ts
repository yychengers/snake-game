...
export const ACHIEVEMENTS: AchievementDefinition[] = [
  { id: 'first_bite', title: 'First Bite', description: 'Eat your first food.', target: 1 },
  { id: 'getting_warmed_up', title: 'Getting Warmed Up', description: 'Eat 50 foods in total.', target: 50 },
  { id: 'score_chaser', title: 'Score Chaser', description: 'Reach 100 score in a single run.', target: 100 },
  { id: 'marathon_snake', title: 'Marathon Snake', description: 'Play 20 runs.', target: 20 },
  { id: 'combo_rookie', title: 'Combo Rookie', description: 'Reach combo 3 in a single run.', target: 3 },
  { id: 'combo_master', title: 'Combo Master', description: 'Reach combo 8 in a single run.', target: 8 },
  { id: 'speed_runner', title: 'Speed Runner', description: 'Eat 3 speed foods in one run.', target: 3 },
  { id: 'control_specialist', title: 'Control Specialist', description: 'Eat 3 slow foods in one run.', target: 3 },
  { id: 'classic_cleared', title: 'Classic Cleared', description: 'Complete classic mode once.', target: 1 },
  { id: 'obstacle_ace', title: 'Obstacle Ace', description: 'Reach level 5 in obstacle mode.', target: 5 },
  {
    id: 'challenge_pulse',
    title: 'Challenge Pulse',
    description: 'Finish a challenge run with high combo.',
    hidden: true,
    hint: 'Finish a challenge run with a strong combo chain.',
    target: 6,
  },
  {
    id: 'endless_spirit',
    title: 'Endless Spirit',
    description: 'Score 120 in endless mode.',
    hidden: true,
    hint: 'In endless mode, survive long enough to score high.',
    target: 120,
  },
];
